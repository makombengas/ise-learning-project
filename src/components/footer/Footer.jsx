        ...
        <div className="max-w-[90rem] mx-auto py-16 grid grid-cols-1 px-4 place-content-center gap-8  md:grid-cols-3 xl:grid-cols-6 ">
            <div className="flex flex-col justify-center items-center md:items-start  md:justify-start h-full gap-2   ">
               <Image src={footer("image")} priority className=" rounded-lg object-cover w-[5rem] h-[2.5rem]" alt="hero" width={1000} height={1000} />
                <p className="text-[#b2b2b2] text-[.875rem] text-center md:text-left md:text-[1.25rem] font-thin  ">
                    {footer("title")}
                </p>
            </div>
            ...
            <div className="flex flex-col justify-center items-center md:items-start  md:justify-start h-full   ">
                ...
                <div className="text-[#b2b2b2] text-center md:text-left text-lg flex flex-col mt-4 gap-2">
                    ...
                    <p>T <a className="hover:text-[#f39900]" href="tel:++49 441 68006-11">+49 441 68006-11</a></p>
                    <p>F <a className="hover:text-[#f39900]" href="tel:++49 441 68006-15">+49 441 68006-15</a></p>
                ...
                <div className="text-[#b2b2b2] text-center md:text-left text-lg flex flex-col mt-4 gap-2">
                    ...
                    <p>T <a className="hover:text-[#f39900]" href="tel:++49 441 68006-0">+49 441 68006-0</a></p>
                    <p>F <a className="hover:text-[#f39900]" href="tel:++49 441 68006-10">+49 441 68006-10</a></p>
                    <p>E  <a className="hover:text-[#f39900]" href="mailto: info@ise.de"> info@ise.de</a></p>
                </div>
            ...
            <div className="flex  flex-col justify-center items-center md:items-start  md:justify-start h-full  ">
                ...
                <Link href={"#"} className="hover:text-[#f39900]" > 
                    <FaFacebook />
                </Link>
                <Link href={"#"} className="hover:text-[#f39900]" > 
                    <FaInstagram />           
