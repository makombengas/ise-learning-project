  ...
  return (
    <div className="py-8  md:py-16 w-full xl:border-[.5px] xl:border-dotted  bg-gradient-to-r from-[#2a2a2718] via-[#2a2a2721] to-[#2a2a271b]  rounded-lg mb-16 h-auto max-w-[90rem] gap-8 mx-auto grid grid-cols-1 md:grid-cols-2 ">
        <div className="flex flex-col gap-4 justify-center items-center">
            ...
            <p className="text-[#3C4448] mx-16 text-center text-sm md:text-xl font-thin">
                {jobOffers("subtitle")}
            </p>
            <Link href="/" className="  hover:bg-[#f39900] border-[#f39900] border-2 text-[#f39900]  hover:scale-105 hover:border-none  transition-all duration-200 ease-in hover:text-[#3C4448] font-semibold bg-transparent  float-center md:float-start mt-5  px-4 py-2 rounded-md">  {jobOffers("btn")} </Link>
        </div>
